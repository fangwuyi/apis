...
class API
{
    ...
    /**
     * ptu_imgfilter 天天P图 滤镜.
     * @param array $bucketList
     */
    public static function ptu_imgfilter($params)
    {
        $params['sign'] = Signature::getReqSign($params);
        $url = Configer::API_URL_PATH . 'ptu/ptu_imgfilter';
        $response = HttpUtil::doHttpPost($url, $params);
        return $response;
    }

    /**
     * ptu_imgfilter 天天P图 美妆.
     * @param array $bucketList
     */
    public static function ptu_facecosmetic($params)
    {
        $params['sign'] = Signature::getReqSign($params);
        $url = Configer::API_URL_PATH . 'ptu/ptu_facecosmetic';
        $response = HttpUtil::doHttpPost($url, $params);
        return $response;
    }
}